...
#    - 会生成所有可能的三组合（climate × policy × uncertainty）
#    - 不依赖二组合的结果，直接处理所有三组合
#    - 适合需要快速测试所有三组合的场景
# 
# 设置为 False 时，按正常流程：先处理二组合，再基于有效二组合生成三组合
#    - 先处理三种类型的二组合（climate+policy, climate+uncertainty, policy+uncertainty）
#    - 只生成那些三个二组合都有效的三组合
#    - 更高效，但需要先完成二组合处理
# 
# 使用方法：修改下面的值即可
...
account_configs = [
    # {
    #     'username': '22022100793932',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 1
    # },
    # {
    #     'username': '22022100793940',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 2
    # },
    # {
    #     'username': '22022100793957',
    #     'password': '0369',
    #     'driver': None,
    #     'thread_id': 3
    # },
    # {
    #     'username': '22022100793965',
    #     'password': '2004',
    #     'driver': None,
    #     'thread_id': 4
    # },
    # {
    #     'username': '22022100793973',
    #     'password': '1995',
    #     'driver': None,
    #     'thread_id': 5
    # },
    # {
    #     'username': '22022100793981',
    #     'password': '0147',
    #     'driver': None,
    #     'thread_id': 6
    # },
    # {
    #     'username': '22022100794062',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 7
    # },
    # {
    #     'username': '22022100794070',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 8
    # },
    # {
    #     'username': '22022100794104',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 9
    # },
    # {
    #     'username': '22022100794112',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 10
    # },
    {
        'username': '22022100794666',
        'password': '1234',
        'driver': None,
        'thread_id': 11
    },
    {
        'username': '22022100794658',
        'password': '1234',
        'driver': None,
        'thread_id': 12
    },
    {
        'username': '22022100794674',
        'password': '1234',
        'driver': None,
        'thread_id': 13
    },
    {
        'username': '22022100794682',
        'password': '1234',
        'driver': None,
        'thread_id': 14
    },
    {
        'username': '22022100794690',
        'password': '1234',
        'driver': None,
        'thread_id': 15
    },
    {
        'username': '22022100794708',
        'password': '1234',
        'driver': None,
        'thread_id': 16
    },
    {
        'username': '22022100794716',
        'password': '1234',
        'driver': None,
        'thread_id': 17
    },
    {
        'username': '22022100794724',
        'password': '1234',
        'driver': None,
        'thread_id': 18
    },
    {
        'username': '22022100795309',
        'password': '1234',
        'driver': None,
        'thread_id': 19
    },
    {
        'username': '22022100795317',
        'password': '1234',
        'driver': None,
        'thread_id': 20
    },
    {
        'username': '22022100796232',
        'password': '1234',
        'driver': None,
        'thread_id': 21
    },
    {
        'username': '22022100796240',
        'password': '1234',
        'driver': None,
        'thread_id': 22
    },
    {
        'username': '22022100796257',
        'password': '1234',
        'driver': None,
        'thread_id': 23
    },
    {
        'username': '22022100796265',
        'password': '1234',
        'driver': None,
        'thread_id': 24
    },
    {
        'username': '22022100796273',
        'password': '1234',
        'driver': None,
        'thread_id': 25
    },
    # {
    #     'username': '22022100796281',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 26
    # },
    # {
    #     'username': '22022100796711',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 27
    # },
    # {
    #     'username': '22022100796729',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 28
    # },
    # {
    #     'username': '22022100796737',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 29
    # },
    # {
    #     'username': '22022100796745',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 30
    # },
    # {
    #     'username': '22022100796752',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 31
    # },
    # {
    #     'username': '22022100796760',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 32
    # },
    # {
    #     'username': '22022100796778',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 33
    # },
    # {
    #     'username': '22022100796786',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 34
    # },
    # {
    #     'username': '22022100796794',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 35
    # },
    # {
    #     'username': '22022100796802',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 36
    # },
    # {
    #     'username': '22022100796810',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 37
    # },
    # {
    #     'username': '22022100796828',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 38
    # },
    # {
    #     'username': '22022100796836',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 39
    # },
    # {
    #     'username': '22022100796844',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 40
    # },
    # {
    #     'username': '22022100796851',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 41
    # },
    ...
    # },
    # {
    #     'username': '22022100795325',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 51
    # },
    # {
    #     'username': '22022100795333',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 52
    # },
    # {
    #     'username': '22022100795341',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 53
    # },
    # {
    #     'username': '22022100794575',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 54
    # },
    # {
    #     'username': '22022100794583',
    #     'password': '1234',
    #     'driver': None,
    #     'thread_id': 55
    # },
...
def get_task_folder_path(task_filename):
    """根据任务文件名生成对应的文件夹路径"""
    # 从文件名中提取任务标识（去掉.xlsx后缀）
    task_name = task_filename.replace('.xlsx', '')
    return f"task_data/{task_name}"

def ensure_task_folder_exists(task_filename):
    """确保任务文件夹存在，如果不存在则创建"""
    folder_path = get_task_folder_path(task_filename)
    if not os.path.exists(folder_path):
        os.makedirs(folder_path, exist_ok=True)
    return folder_path

def get_task_file_path(task_filename, file_type="results"):
    """获取任务相关的文件路径"""
    folder_path = ensure_task_folder_exists(task_filename)
    if file_type == "condition":
        return os.path.join(folder_path, "condition.txt")
    elif file_type == "results":
        return os.path.join(folder_path, "results.txt")
    elif file_type == "failed_conditions":
        return os.path.join(folder_path, "failed_conditions.txt")
    elif file_type == "two_combo_results":
        return os.path.join(folder_path, f"two_combo_results_{task_filename.replace('.xlsx', '.txt')}")
    elif file_type == "month_stats_cache":
        return os.path.join(folder_path, "month_stats_cache.json")
    else:
        return os.path.join(folder_path, f"{file_type}.txt")

def append_to_file(content, mode='a', filename="results.txt", task_filename=None):
    """将查询得到的字符串按行追加到txt文件"""
    # 如果提供了task_filename，使用任务相关的文件路径
    if task_filename:
        if "condition" in filename:
            file_path = get_task_file_path(task_filename, "condition")
        elif "failed_conditions" in filename:
            file_path = get_task_file_path(task_filename, "failed_conditions")
        else:
            file_path = get_task_file_path(task_filename, "results")
    else:
        file_path = filename
...
def read_as_set(filename="results.txt", task_filename=None):
...
def request_and_map(filter_html, task_filename=None):
    ...
    for filter_root in filter_root_list:
        ...
        # 追加查询结果到临时文件
        append_to_file(str, task_filename=task_filename)
...
def crawl_data(file_name, pubname, date_range, climate, policy, uncertainty, logger_thread):
    ...
    if SKIP_TWO_COMBO:
        # 直接生成所有三组合，跳过二组合处理
        logger_thread.info('=' * 80)
        logger_thread.info('🚀 启用直接三组合模式：跳过二组合处理，直接搜索所有三组合')
        logger_thread.info('=' * 80)
        ...
        logger_thread.info(f'直接生成所有三组合，共 {len(all_combinations)} 个')
        logger_thread.info(f'  - climate关键词: {len(climate_list)} 个')
        logger_thread.info(f'  - policy关键词: {len(policy_list)} 个')
        logger_thread.info(f'  - uncertainty关键词: {len(uncertainty_list)} 个')
        
        # 检查已完成的三组合条件
        last_conditions = read_as_set(filename='condition.txt', task_filename=file_name)
        ...
        if len(remaining_combinations) == 0:
            logger_thread.info('所有三组合已完成，直接进行年份统计')
            # 跳转到年份统计部分（需要找到年份统计的代码位置）
            # 这里需要添加跳转逻辑，或者将年份统计代码提取为函数
        else:
            # 直接三组合模式：跳转到三组合处理逻辑
            logger_thread.info(f'🚀 直接三组合模式：开始处理 {len(remaining_combinations)} 个三组合')
            # remaining_combinations 已经定义，直接跳转到三组合处理部分
            # 设置一个标志，让后续代码知道这是直接模式
            pass  # 继续执行后面的三组合处理代码
    else:
        # 正常流程：先处理二组合
        logger_thread.info('=' * 80)
        logger_thread.info('📋 正常模式：先处理二组合，再基于有效二组合生成三组合')
        logger_thread.info('=' * 80)
        ...
        # 检查已处理的二组合 - 支持三种类型
        two_combo_results_file = get_task_file_path(file_name, "two_combo_results")
                    ...
                    if line.strip():
                        ...
                        if len(parts) == 4:  # 新格式：type|||param1|||param2|||result_count
                            ...
                            try:
                                ...
                                elif result_count_int < 0:  # -1 或 -2 的失败情况
                                    failed_two_combos.add(combo_key)
                            except ValueError:
                                logger_thread.warning(f'无效的结果计数格式: {line.strip()}, 跳过此记录')
    ...
    # ==================== 三组合处理逻辑 ====================
    # 如果SKIP_TWO_COMBO为True，remaining_combinations已经在上面定义过了
    if not SKIP_TWO_COMBO:
        # 正常模式：基于有效的二组合生成三组合
        ...
        def process_combination_with_driver(combination_data):
            ...
            try:
                            ...
                            if target_config:
                                ...
                                if recreate_success:
                                    ...
                                    if uncertainty_data == "DEEP_RESET_FAILED":
                                        ...
                                        append_to_file(failed_condition, mode='a', filename='failed_conditions.txt', task_filename=file_name)
                ...
                if uncertainty_total == 0:
                    ...
                    append_to_file(condition, mode='a', filename='condition.txt', task_filename=file_name)
                    return True
                else:
                ...
                # 处理第一页数据
                request_and_map(uncertainty_data, task_filename=file_name)
                ...
                while (page + 1) * max_results < int(uncertainty_total):
                    ...
                    try:
                        ...
                        if is_page_exist:
                            ...
                            page_data = current_driver.page_source
                            request_and_map(page_data, task_filename=file_name)
    ...
    # 处理失败的组合
    failed_conditions_file = get_task_file_path(file_name, "failed_conditions")
    if os.path.exists(failed_conditions_file):
        failed_conditions = read_as_set(filename='failed_conditions.txt', task_filename=file_name)
    ...
    # ==================== 月份统计部分 ====================
    # 加载缓存文件
    month_stats_cache_file = get_task_file_path(file_name, "month_stats_cache")
    month_stats_cache = {}
    if os.path.exists(month_stats_cache_file):
        try:
            import json
            with open(month_stats_cache_file, 'r', encoding='utf-8') as f:
                month_stats_cache = json.load(f)
            logger_thread.info(f'📂 加载月份统计缓存，已有 {len(month_stats_cache)} 个月份的数据')
        except Exception as e:
            logger_thread.warning(f'⚠️ 加载月份统计缓存失败: {e}，将重新统计')
            month_stats_cache = {}
    
    # 月份统计数据字典，格式: {"202201": "1234", "202202": "5678", ...}
    month_map = {}
    
    def process_month_stats(year, month):
        """处理单个年月的统计"""
        current_driver = None
        year_month_key = f"{year}{month:02d}"  # 格式: 202201
        
        # 检查缓存
        if year_month_key in month_stats_cache:
            cached_value = month_stats_cache[year_month_key]
            logger_thread.info(f'[统计线程|月份统计] 💾 {year}年{month}月使用缓存数据: {cached_value} 条')
            return year, month, cached_value
        ...
        try:
            ...
            # 计算月份的开始和结束日期
            # 月份格式: 2022.1 表示2022年1月
            import calendar
            date_from = f"{year}.{month}"
            # 计算该月的最后一天
            ...
            current_url = current_driver.current_url
            logger_thread.info(f'[统计线程|月份统计] 📍 {year}年{month}月统计URL: {current_url}')
            
            WebDriverWait(current_driver, 100).until(
                EC.presence_of_element_located((By.ID, "main-content"))
            )
            month_data = current_driver.page_source
            month_total = get_total(month_data)
            logger_thread.info(f'[统计线程|月份统计] 📈 {year}年{month}月统计完成，总数: {month_total} 条')
            
            # 更新缓存
            month_stats_cache[year_month_key] = str(month_total)
            
            return year, month, str(month_total)
        except Exception as e:
            logger_thread.error(f'❌ [统计线程|月份统计] {year}年{month}月统计失败: {e}')
            return year, month, "0"
        finally:
            # 将driver放回队列
            if current_driver:
    ...
    logger_thread.info(f'[统计线程|月份统计] 📋 开始统计 {len(month_tasks)} 个月份的数据')
    
    # 使用多线程处理月份统计
    with concurrent.futures.ThreadPoolExecutor(max_workers=min(len(available_drivers), len(month_tasks))) as executor:
        # 提交所有月份统计任务
        month_futures = {
            executor.submit(process_month_stats, year, month): (year, month)
        ...
        for future in concurrent.futures.as_completed(month_futures):
            year, month = month_futures[future]
            try:
                result_year, result_month, result_total = future.result()
                year_month_key = f"{result_year}{result_month:02d}"
                month_map[year_month_key] = result_total
                completed_months += 1
                logger_thread.info(f'[统计线程|月份统计] ✅ {result_year}年{result_month}月统计任务完成 ({completed_months}/{len(month_tasks)})')
            except Exception as exc:
                completed_months += 1
                year_month_key = f"{year}{month:02d}"
                month_map[year_month_key] = "0"
                logger_thread.error(f'❌ [统计线程|月份统计] {year}年{month}月统计任务异常: {exc} ({completed_months}/{len(month_tasks)})')
    
    logger_thread.info(f'[统计线程|月份统计] 🎉 所有月份统计完成，共 {len(month_map)} 个月份')
    
    # 保存缓存到文件
    try:
        import json
        with open(month_stats_cache_file, 'w', encoding='utf-8') as f:
            json.dump(month_stats_cache, f, ensure_ascii=False, indent=2)
        logger_thread.info(f'💾 月份统计缓存已保存到: {month_stats_cache_file}')
    except Exception as e:
        logger_thread.error(f'❌ 保存月份统计缓存失败: {e}')
    ...
    # 归档任务文件
    archive_success = archive_task_files(file_name)
    if archive_success:
        logger_thread.info(f'✅ 任务文件已归档: {file_name}')
    else:
        logger_thread.warning(f'⚠️ 任务文件归档失败: {file_name}')
...
def archive_task_files(task_filename):
    ...
    try:
        # 确保任务文件夹存在
        task_folder = ensure_task_folder_exists(task_filename)
        
        # 记录归档信息
        archive_info = f"任务文件已归档到: {task_folder}\n"
        archive_info += f"包含文件: condition.txt, results.txt, failed_conditions.txt, two_combo_results_*.txt\n"
        archive_info += f"归档时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n"
        
        # 创建归档信息文件
        archive_info_path = os.path.join(task_folder, "archive_info.txt")
...
def cleanup_old_files():
    """清理根目录下的旧文件，将它们移动到对应的任务文件夹"""
    try:
        # 检查根目录下是否有旧的文件
        old_files = ['condition.txt', 'results.txt', 'failed_conditions.txt']
        
        # 查找所有 two_combo_results_ 开头的文件
        import glob
        two_combo_files = glob.glob('two_combo_results_*.txt')
        old_files.extend(two_combo_files)
        ...
        for old_file in old_files:
            if os.path.exists(old_file):
                ...
                if content.strip():  # 如果文件有内容
                    # 创建通用任务文件夹
                    generic_folder = "task_data/legacy_files"
                    os.makedirs(generic_folder, exist_ok=True)
                    
                    # 移动文件到通用文件夹
                    new_path = os.path.join(generic_folder, f"{old_file}_{datetime.now().strftime('%Y%m%d_%H%M%S')}")
                    with open(new_path, 'w', encoding='utf-8') as f:
                        f.write(content)
                    
                    # 删除原文件
                    os.remove(old_file)
                    print(f"已移动旧文件 {old_file} 到 {new_path}")
                else:
                    # 文件为空，直接删除
                    os.remove(old_file)
                    print(f"已删除空的旧文件 {old_file}")
...
if __name__ == '__main__':
    ...
    # 清理根目录下的旧文件
    logger_global.info('开始清理根目录下的旧文件...')
    cleanup_success = cleanup_old_files()
    if cleanup_success:
        logger_global.info('✅ 旧文件清理完成')
    else:
        logger_global.warning('⚠️ 旧文件清理失败')
